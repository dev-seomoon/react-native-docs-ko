...
[Android Studio를 다운로드하고 설치](https://developer.android.com/studio/index.html)하십시오. Android Studio 설치 마법사에서 다음 모든 항목 옆의 확인란이 선택되어 있는지 확인합니다:
...
먼저 React Native와 함께 제공되는 JavaScript 번들러인 Metro를 시작해야합니다. Metro는 "입력 파일과 다양한 옵션을 가져 와서 모든 코드와 해당 종속성을 포함하는 단일 JavaScript 파일을 반환합니다."—[Metro Docs](https://facebook.github.io/metro/docs/concepts)
